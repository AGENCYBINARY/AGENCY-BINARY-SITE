        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-8 animate-slide-in-left animate-stagger-1">
            ...
            <div className="space-y-6">
                <div className="flex items-start bg-white/80 p-4 rounded-xl border border-gray-300/40 animate-slide-up animate-stagger-2 hover:scale-105 hover:shadow-lg hover:shadow-indigo-500/20 transition-all duration-300 will-change-transform">
              ...
              <div className="flex items-start bg-white/80 p-4 rounded-xl border border-gray-300/40 animate-slide-up animate-stagger-3 hover:scale-105 hover:shadow-lg hover:shadow-indigo-500/20 transition-all duration-300 will-change-transform">
                <div className="text-indigo-600 text-xl mr-4">
                  <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
